    ...
    const cartSvg = (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24">
            <path
                ...
                d="M3 3H5L5.4 5M7 13H17L21 5H5.4M7 13L5.4 5M7 13L4.707 15.293C4.077 15.923 4.523 17 5.414 17H17M17 17a2 2 0 100 4 2 2 0 000-4zM9 19a2 2 0 11-4 0 2 2 0 000-4z"
            />
        </svg>
    );
            ...
            {isMobileMenuOpen && (
                <div className="fixed top-0 right-0 h-full w-1/2 bg-white dark:bg-gray-900 shadow-lg p-6 z-40 md:hidden">
                    <div className="flex flex-col space-y-6">
                        ...
                        <Link to="/image-search" onClick={() => setIsMobileMenuOpen(false)} className="text-lg text-gray-800 dark:text-white hover:text-blue-600 hover:dark:text-blue-400">
                            Image Search
                        </Link>
                        <button
                            onClick={() => {
